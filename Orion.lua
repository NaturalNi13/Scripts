...
function OrionLib:MakeWindow(WindowConfig)
    ...
    -- Handle Enter key for new line functionality
    AddConnection(TextboxActual:GetPropertyChangedSignal("Text"), function()
        if TextboxConfig.AllowNewLine then
            TextboxActual.InputBegan:Connect(function(input)
                if input.UserInputType == Enum.UserInputType.Keyboard and input.KeyCode == Enum.KeyCode.Return then
                    TextboxActual.Text = TextboxActual.Text .. "\n" -- Add a new line
                    TextboxActual:CaptureFocus() -- Keep the focus on the TextBox
                end
            end)
        end
    end)
